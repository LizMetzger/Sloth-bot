...
int main()
{
    ...
    while (true)
    {
        ...
        move_servos(1, 255, 180, dxl_comm_result, packetHandler, portHandler, dxl_present_position, dxl_error);
        printf("?!");
        // rotate hand 
        ...
        move_servos(1, 233, 255, dxl_comm_result, packetHandler, portHandler, dxl_present_position, dxl_error);
        printf("?!?!??");
        }
        }
